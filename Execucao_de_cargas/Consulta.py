...
select distinct 
    ...
    case
    	when t.total_amount is null then frt.v_final_amount :: text
    	else t.total_amount :: text
    end as "VALOR_TOTAL",
...
WHERE frt.deleted != true
	and frt.entry_date between '2024-06-01' and '2026-12-31'
...
try:
    print("Conectando ao banco de dados e executando a consulta...")
    connection = psycopg2.connect(**db_params)
    df = pd.read_sql_query(query, connection)
    
    output_file = "C:\\Users\\matheus.fagundes\\Documents\\Dash_Cobranca\\Bases\\Faixa.csv"
    
    # Exportando com o delimitador ';' para casar com a leitura do Streamlit
