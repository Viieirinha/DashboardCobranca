...
st.sidebar.image(f"C:\\Users\\savio.menezes\\Documents\\Dash_Cobranca\\Imagens\\Group 211.svg", use_container_width=True)
...
with tab1:
    ...
    if not max_row.empty:
        ...
        st.sidebar.image(f"C:\\Users\\savio.menezes\\Documents\\Dash_Cobranca\\Imagens\\trofeu.png", use_container_width=True)
